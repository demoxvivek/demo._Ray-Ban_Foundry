          ...
          {data?.lines?.map((el, index) => (
            <>
              <Item key={index}>
                ...
                <ItemPrice>{amountPrint(el?.linePriceWithTax / 100)}</ItemPrice>
              </Item>
          ...
          >
            <Summary>
              ...
              >
                ...
                <span style={{ fontSize: "26px", margin: "18px 0" }}>
                  {amountPrint(data?.totalWithTax / 100)}
                </span>
              </SummaryRow>
            </Summary>
          </div>
